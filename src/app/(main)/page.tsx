  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-end justify-between">
        <div>
          <p className="text-[#d4a537] text-sm font-semibold tracking-wider uppercase mb-1">Overview</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="group relative bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-xl hover:shadow-[#2d3e50]/5 transition-all duration-300 overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-5xl font-bold text-[#2d3e50] mt-1" style={{ fontFamily: "'Montserrat', sans-serif" }}>{memberCount}</p>
            <Link
              href="/members"
        ...
        <div className="group relative bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-xl hover:shadow-[#d4a537]/10 transition-all duration-300 overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-gray-400 text-sm font-medium uppercase tracking-wider">Total Events</p>
            <p className="text-5xl font-bold text-[#2d3e50] mt-1" style={{ fontFamily: "'Montserrat', sans-serif" }}>{eventCount}</p>
            <Link
              href="/events"
              className="inline-flex items-center gap-2 mt-4 text-[#2d3e50] text-sm font-medium hover:text-[#d4a537] transition-colors"
            >
        ...
        <div className="group relative bg-gradient-to-br from-[#2d3e50] to-[#1a2836] rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-white/60 text-sm font-medium uppercase tracking-wider">Venue Layouts</p>
            <p className="text-5xl font-bold text-white mt-1" style={{ fontFamily: "'Montserrat', sans-serif" }}>{layoutCount}</p>
            <Link
              href="/layouts"
