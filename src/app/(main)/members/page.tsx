  ...
  return (
    <div className="h-[calc(100vh-8rem)] flex flex-col">
      ...
      <div className="flex justify-between items-center mb-4">
        <div>
          <h1 className="text-2xl font-semibold text-[#2d3e50]">Members</h1>
        ...
        <Link
          href="/members/new"
          className="flex items-center gap-2 px-4 py-2.5 bg-[#2d3e50] text-white rounded-lg hover:bg-[#3d5068] transition-colors font-medium text-sm"
        >
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 mb-4">
        <div className="flex flex-wrap gap-3">
          ...
          <select
            ...
            className="px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#d4a537] bg-white min-w-[150px]"
          >
          ...
          <select
            ...
            className="px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#d4a537] bg-white min-w-[120px]"
          >
          ...
          <select
            ...
            className="px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#d4a537] bg-white min-w-[140px]"
          >
